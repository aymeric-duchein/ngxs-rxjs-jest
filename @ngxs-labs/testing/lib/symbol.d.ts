...
export declare type ResetFn<T = any> = (state: T) => T;
export declare type SnapshotFn<T = any> = () => T;
export declare type DispatchFn<T = any, U = any> = (event: U | U[]) => Observable<T>;
export declare type SelectFn<T = any, U = any> = ((selector: string) => Observable<T>) | ((selector: Type<U>) => Observable<T>) | ((selector: any) => Observable<T>);
export declare type SelectSnapshotFn<T = any, U = any> = ((selector: string) => T) | ((selector: Type<U>) => T) | ((selector: any) => T);
